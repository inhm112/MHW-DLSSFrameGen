...
class MenuCommon
{
  private:
    ...
    enum class MhwFgMenuPage : uint8_t
    {
        Home,
        Advanced,
    };

    inline static MhwFgMenuPage _mhwFgMenuPage = MhwFgMenuPage::Home;
    ...
    static void RenderMhwFgMenuNavigation(RenderMenuContext& ctx);
    static void RenderMhwFgHomePage(RenderMenuContext& ctx);
    ...
    static void RenderFramerateSettings(RenderMenuContext& ctx, bool compact = false);
    ...
    static void RenderMainMenuBottomBar(RenderMenuContext& ctx, bool compact = false);
